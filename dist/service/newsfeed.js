...
var subs_1 = require("../entity/subs");
...
var subs = new subs_1.Subs();
var school = new school_1.School();
var NewsfeedService = /** @class */ (function (_super) {
    __extends(NewsfeedService, _super);
    function NewsfeedService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NewsfeedService.prototype.getNewsFeedList = function (studentIdx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        repo = _a.sent();
                        return [4 /*yield*/, repo.createQueryBuilder(subs_1.Subs, 'subs')
                                .select('*')
